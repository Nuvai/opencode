...
export namespace Flag {
  ...
  export const OPENCODE_DISABLE_TERMINAL_QUERIES = truthy("OPENCODE_DISABLE_TERMINAL_QUERIES")
  export const OPENCODE_FORCE_TERMINAL_QUERIES = truthy("OPENCODE_FORCE_TERMINAL_QUERIES")
